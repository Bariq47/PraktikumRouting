...
<body>
    ...
    <a href="{{ url('/basic_routing') }}" class="list-group-item listgroup-item-action">
        Basic Routing (No View, No Controller)
    </a>
    <a href="{{ url('/view_route') }}" class="list-group-item listgroup-item-action">
        View Route
    </a>
    ...
    <a href="{{ url('/username') }}" class="list-group-item list-groupitem-action">
        Route Parameter (Optional Parameter)
    </a>

    <a href="{{ url('/title/this-is-my-title') }}" class="list-groupitem list-group-item-action">
    ...
    <a href="{{ url('/route_priority/user') }}" class="list-group-itemlist-group-item-action">
        Route Priority
    </a>

    <a href="{{ url('/asdqwezxc') }}" class="list-group-item list-groupitem-action">
        Fallback Routes
    </a>
...
<a href="{{ url('/routing_clone') }}" class="list-group-item list-group-item-action">
    clone
</a>
